...
# resource "oci_core_public_ip" "secondary_client_public_ip" {
#   compartment_id = var.compartment_id
#   display_name   = "reserved public ip 1"
#   lifetime       = "RESERVED"
#   private_ip_id  = oci_core_private_ip.floating_client_private_ip.id
#   #defined_tags   = oci_core_private_ip.client_vnic_private_ip.defined_tags
# }
...
# output "client_vip_public_ip" { value = oci_core_public_ip.vip_public_ip.ip_address }
# output "secondary_client_floating_public_ip" { value = oci_core_public_ip.secondary_client_public_ip.ip_address }
